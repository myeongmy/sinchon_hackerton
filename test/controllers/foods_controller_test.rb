...
class FoodsControllerTest < ActionController::TestCase
  ...
  test "should create food" do
    assert_difference('Food.count') do
      post :create, food: { fname: @food.fname, material1: @food.material1, material2: @food.material2 }
    end
  ...
  test "should update food" do
    patch :update, id: @food, food: { fname: @food.fname, material1: @food.material1, material2: @food.material2 }
    assert_redirected_to food_path(assigns(:food))
  end
